...
/**
 *        Code PIN
 * !NESSESAIRE! pour dévérouiller la carte SIM. 
 * 4 digit sont attendue ex: PIN="XXXX";
 */
String GSM_PIN = "1234";
...
void loop() {
  ...
  if(Serial.available()!= 0) {
    char x = Serial.read();
      ...
      if (x == 67 or x == 99) { // C ou c état de la connection réseau
        Serial.print("commande envoyé : ");
        Serial.println(char(x));
        Serial.println (gsm_connected());
        }
